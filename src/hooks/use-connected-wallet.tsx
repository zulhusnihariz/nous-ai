      ...
      case CURRENT_CHAIN.SOLANA:
        {
          ...
          setCurrentWalletState({ balance: { formatted: `${balance / LAMPORTS_PER_SOL}`, symbol: 'SOL' } })
        }
        break
      case CURRENT_CHAIN.NEAR:
        {
          if (near.provider) {
            ...
            setCurrentWalletState({ balance: { formatted: `${displayNearBalance}`, symbol: 'NEAR' } })
            return
          }

          setCurrentWalletState({ balance: { formatted: `${0}`, symbol: 'NEAR' } })
        }
        break
      default:
        break

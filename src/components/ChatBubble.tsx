  ...
  return (
    <>
      <div className={`flex p-2 my-2 mx-1 md:mx-16 lg:mx-40 ${prop.className}`}>
        {prop.img.length > 0 && (
          <img alt="avatar" src={prop.img as string} className="h-8 w-8 md:h-10 md:w-10 rounded-md object-cover border-[1px] border-[#333335]" />
        )}
        {prop.img.length <= 0 && <span className="h-8 w-8 md:h-10 md:w-10 rounded-md bg-red-100"></span>}
